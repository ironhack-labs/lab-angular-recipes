...
const foods = [
  ...
  {
    name: "Gnocchi",
    image: "https://c1.staticflickr.com/8/7038/6944665187_b8cd703bc2.jpg",
    description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."
  },
  {
    name: "Pot Roast",
...
const ingredients = [
    {
      name: "Caca",
      image:
        "https://rolloid.net/wp-content/uploads/2015/03/emoji-caca-696x392.jpg",
      description:
        "Lorem fistrum qué dise usteer te va a hasé pupitaa ese hombree sed minim veniam ut occaecat ese hombree ex. Commodo va usté muy cargadoo quis ahorarr aliquip amatomaa."
    },
    {
      name: "Palomitas",
      image:
        "https://images-na.ssl-images-amazon.com/images/I/71IFuRy1uwL._SL1229_.jpg",
      description:
        "Lorem fistrum qué dise usteer te va a hasé pupitaa ese hombree sed minim veniam ut occaecat ese hombree ex. Commodo va usté muy cargadoo quis ahorarr aliquip amatomaa."
    },
    {
      name: "Agua Bendita",
      image:
        "http://www.minutosdeamor.com/wp-content/uploads/2017/09/papa-francisco-aspergiendo-agua-bendita-1024x576.jpg",
      description:
        "Lorem fistrum qué dise usteer te va a hasé pupitaa ese hombree sed minim veniam ut occaecat ese hombree ex. Commodo va usté muy cargadoo quis ahorarr aliquip amatomaa."
    }
  ]
